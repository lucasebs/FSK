...
# Title: Top Block
# Generated: Thu Aug  2 00:25:17 2018
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "scope2")
        self.Add(self.notebook_0)
        self.nb1 = self.nb1 = wx.Notebook(self.GetWin(), style=wx.NB_LEFT)
        self.nb1.AddPage(grc_wxgui.Panel(self.nb1), "fftsource")
        self.nb1.AddPage(grc_wxgui.Panel(self.nb1), "scopesource")
        self.Add(self.nb1)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0, 0, 0,0,0,1,1,0,1,0,1,0,0,1,1,1,0,0,1,0,1), True, 1, [])
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 4400, 1, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100, 1, 0)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(-56)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.wxgui_scopesink2_0_0.set_sample_rate(self.samp_rate*2)
