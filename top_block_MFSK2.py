...
# Title: Top Block Mfsk2
# Generated: Fri Aug  3 01:20:12 2018
##################################################
...
class top_block_MFSK2(gr.top_block, Qt.QWidget):
    ...
    def set_MFSK(self, MFSK):
        self.MFSK = MFSK


def main(top_block_cls=top_block_MFSK2, options=None):
